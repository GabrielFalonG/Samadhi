...
<div class="min-h-screen bg-slate-100" x-data="{ showConfirmModal: false }">
    <div class="p-5 lg:p-10">
        ...
        <nav class="mb-5 flex items-center gap-2 text-sm text-slate-500">
            ...
            <span>/</span>
            <span class="font-medium text-slate-700">Actualizar producto</span>
        </nav>

        {{-- Header --}}
        <div class="mb-8 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
                <h1 class="text-4xl font-bold text-slate-900">Actualizar producto</h1>
        ...
        {{-- FORMULARIO --}}
        @include('livewire.products.products-form', ['isEditing' => true])
    </div>
    ...
    <div x-data="{ showModal: @entangle('showConfirmModal') }"
        ...
        <div @click.away="showModal = false"
            ...
            <p class="mt-3 text-center text-base leading-relaxed text-slate-500">
                ¿Estás seguro que deseas actualizar los datos del producto?
            </p>
