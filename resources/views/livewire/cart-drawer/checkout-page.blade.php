<section class="bg-[#F8F6F2] min-h-screen">
    <div x-data @order:confirmed.window="window.scrollTo({ top: 0, behavior: 'smooth' })"
         class="mx-auto max-w-7xl px-5 py-10 lg:px-8 lg:py-14">
        ...
        @if ($orderConfirmed)
            {{-- Compra confirmada --}}
            <div class="flex min-h-[60vh] items-center justify-center px-6 py-16">
                <div class="max-w-xl text-center">
                    <div
                        class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#F3EFEA] text-[#A98B68]">
                    ...
                    <span class="mt-6 block text-xs uppercase tracking-[0.3em] text-[#B5956E]">
                        Pedido confirmado
                    </span>
                    ...
                    <p class="mx-auto mt-5 max-w-md text-base leading-7 text-stone-600">
                        Recibimos tu pedido correctamente.
                        Pronto nos pondremos en contacto para continuar con la coordinación.
                    </p>
                    ...
                    <a href="{{ route('home') }}" wire:navigate
                        class="mt-8 inline-flex items-center justify-center rounded-full bg-[#A98B68] px-8 py-3.5 text-sm font-medium text-white transition hover:bg-[#8D7358]">
                        Seguir comprando
                    </a>
                    ...
                    <div class="rounded-[32px] bg-white shadow-[0_15px_45px_rgba(0,0,0,.05)] overflow-hidden">
                        ...
                        <div class="space-y-8 p-6 lg:p-10">
                            ...
                            <div>
                                ...
                                <input id="name" type="text" wire:model.blur="form.customer_name"
                                    placeholder="Ej. Mara Lezcano" @class([
                                        'w-full rounded-2xl bg-white px-5 py-4 text-stone-800 placeholder:text-stone-400 transition-all',
                                        'border border-stone-200 focus:border-[#A98B68] focus:ring-[#A98B68]' => !$errors->has(
                                            'form.customer_name'),
                                        'border border-red-300 focus:border-red-400 focus:ring-red-300' => $errors->has(
                                            'form.customer_name'),
                                    ])>
                            ...
                            <div>
                                ...
                                <input id="phone" type="text" wire:model.blur="form.customer_phone"
                                    placeholder="Ej. +54 9 353 5555555" @class([
                                        'w-full rounded-2xl bg-white px-5 py-4 text-stone-800 placeholder:text-stone-400 transition-all',
                                        'border border-stone-200 focus:border-[#A98B68] focus:ring-[#A98B68]' => !$errors->has(
                                            'form.customer_phone'),
                                        'border border-red-300 focus:border-red-400 focus:ring-red-300' => $errors->has(
                            ...
                            <div>
                                ...
                                <input id="instagram" type="text" wire:model.blur="form.customer_instagram"
                                    placeholder="@samadhi" @class([
                                        'w-full rounded-2xl bg-white px-5 py-4 text-stone-800 placeholder:text-stone-400 transition-all',
                                        'border border-stone-200 focus:border-[#A98B68] focus:ring-[#A98B68]' => !$errors->has(
                            ...
                            <div>
                                ...
                                <input id="email" type="email" wire:model.blur="form.customer_email"
                                    placeholder="tu@email.com" @class([
                                        'w-full rounded-2xl bg-white px-5 py-4 text-stone-800 placeholder:text-stone-400 transition-all',
                                        'border border-stone-200 focus:border-[#A98B68] focus:ring-[#A98B68]' => !$errors->has(
                                            'form.customer_email'),
                                        'border border-red-300 focus:border-red-400 focus:ring-red-300' => $errors->has(
                            ...
                            <div>
                                ...
                                <textarea id="notes" rows="5" wire:model.blur="form.customer_notes"
                                    placeholder="¿Querés agregar algún comentario sobre tu pedido?" @class([
                                        'w-full rounded-2xl bg-white px-5 py-4 text-stone-800 placeholder:text-stone-400 transition-all',
                                        'border border-stone-200 focus:border-[#A98B68] focus:ring-[#A98B68]' => !$errors->has(
                                            'form.customer_notes'),
                                        'border border-red-300 focus:border-red-400 focus:ring-red-300' => $errors->has(
                            ...
                            <div>
                                <label @class([
                                    ...
                                    'bg-[#F8F6F2] border border-transparent' => !$errors->has(
                                        'form.accept_terms'),
                                    'bg-[#FDF5F3] border border-[#E8C5BE]' => $errors->has('form.accept_terms'),
                                ])>
                                    <input type="checkbox" wire:model.blur="form.accept_terms"
                    ...
                    <aside class="self-start lg:sticky lg:top-24 space-y-6">
                            ...
                            <div class="divide-y divide-stone-100">
                                @foreach ($this->form->items as $index => $item)
                                    <div wire:key="cart-item-{{ $item['id'] ?? $index }}"
                                        ...
                                        <div
                                            class="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-[#F5F2EC]">
                        ...
                        <div class="rounded-[32px] bg-white p-7 shadow-[0_15px_45px_rgba(0,0,0,.05)]">
                            <div class="flex gap-4">
                                <div
                                    class="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-green-100 text-green-700 font-bold">
                                    ✓
                                </div>
                                <div>
